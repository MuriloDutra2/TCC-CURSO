...
-->
            ...
            <main>
                <div class="movie-details">
                    ...
                    <div class="movie-image">
                        <img src="assets/image_movie/filme1.jpg" alt="Punhos de aço">
                    </div>

                    <!-- Informações do Filme -->
                    <div class="movie-info">
                        <h2>O Filho Do Homem</h2>

                        <!-- Sinopse -->
                        <p class="sinopse">
                            Ricardo Mariano é o filho do homem mais sábio do planeta terra, Wilson mariano.
                            Após uma conversa com seu próprio pai, ele decide se tornar um tão sábio como seu pai, então
                            ele sai em uma jornada pelo mundo inteiro para conseguir conhecimento e sabedoria.
                        </p>
                        ...
                        <p class="release-date">
                            <strong>Lançamento:</strong> 17 de Março de 2024
                        </p>

                        <!-- Gênero -->
                        <p class="genre">
                            <strong>Gênero:</strong> Aventura e Drama
                        </p>
    ...
    <a href="ingresso_filme/ingresso_filho.html" class="buy-ticket">Comprar Ingresso</a>
<?php else: ?>
