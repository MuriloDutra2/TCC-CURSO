            ...
            <main>
                <div class="movie-details">
                    ...
                    <div class="movie-image">
                        <img src="assets/image_movie/filme7.jpg" alt="tempo de morte">
                    </div>
                    ...
                    <div class="movie-info">
                        ...
                        <!-- Sinopse -->
                        <p class="sinopse">
                            A detetive Teixeira investiga uma série de assassinatos em uma cidade onde uma antiga lenda
                            parece ganhar vida. À medida que o assassino antecipa seus movimentos, Teixeira entra em um
                            jogo mortal para salvar a próxima vítima. "Tempo de Morte" é uma trama intensa sobre
                            suspense e mistério, onde cada segundo conta.
                        ...
                        <!-- Duração -->
                        <p class="duration">
                            <strong>Duração:</strong> 155 minutos
                        </p>

                        <!-- Data de Lançamento -->
                        <p class="release-date">
                            <strong>Lançamento:</strong> 05 de Julho de 2024
                        </p>
                ...
                <div class="movie-cast">
                    ...
                    <div class="cast-container">
                        <div class="cast-item">
                            ...
                            <p class="actor-name">Maria Teixeira</p>
                        </div>
                        <!-- Ator 2-->
                        <div class="cast-item">
                            <img src="assets/atores/heytor.jpg" alt="Ator 1">
