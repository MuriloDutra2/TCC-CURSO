            ...
            <main>
                <div class="movie-details">
                    ...
                    <div class="movie-image">
                        <img src="assets/image_movie/filme3.jpg" alt="A maldicaodoparque">
                    </div>

                    <!-- Informações do Filme -->
                    <div class="movie-info">
                        <h2>A Noite Azul Eterna</h2>

                        <!-- Sinopse -->
                        <p class="sinopse">
                            Noite Eterna Azul, um filme que conta o trama de dois personagens, Fernanda e seu amigo
                            Murilo. Um dia tudo foi normal, até que de repente eles são atacados, mas isso não afeta
                            somente eles. Então, pelo anseio e saudade de como tudo era antes,vão a pusca do responsável
                            de quem fez isso com o mundo, mas espera, ele não é humano. O que vão fazer agora?
                        ...
                        <p class="release-date">
                            <strong>Lançamento:</strong> 11 de Novembro de 2021
                        </p>
                        ...
                        <?php if (isset($_SESSION['usuario'])): ?>
                            <a href="ingresso_filme/ingresso_noite.html" class="buy-ticket">Comprar Ingresso</a>
                        <?php else: ?>
                ...
                <div class="movie-cast">
                    ...
                    <div class="cast-container">
                        <div class="cast-item">
                            <img src="assets/atores/mafe.jfif" alt="Ator 1">
                            <p class="actor-name">Maria Fernanda</p>
                        </div>
                        <!-- Ator 2-->
                        <div class="cast-item">
                            <img src="assets/atores/Murilo.jfif">
                            <p class="actor-name">Murilo Dutra</p>
                        </div>
                        <!-- Ator 3 -->
                        <div class="cast-item">
                            <img src="assets/atores/heytor.jpg">
