            ...
            <main>
                <div class="movie-details">
                    ...
                    <div class="movie-image">
                        <img src="assets/image_movie/filme8.jpg" alt="Punhos de aço">
                    </div>
                    ...
                    <div class="movie-info">
                        ...
                        <!-- Sinopse -->
                        <p class="sinopse">
                            Um trio de meninos estudantes decidem se juntar para solucionar um caso peculiar, pessoas
                            estão desaparecendo?
                            esse será o caso pro agente Dutra, agente Valeriano e agente Labiuc, será um assasino?, um
                            extra-terrestre?, um monstro?venha descobrir!
                        ...
                        <p class="release-date">
                            <strong>Lançamento:</strong> 11 de Junho de 2007
                        </p>

                        <!-- Gênero -->
                        <p class="genre">
                            <strong>Gênero:</strong> Comédia, Ação e Mistério
                        </p>
