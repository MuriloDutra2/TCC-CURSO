            ...
            <main>
                <div class="movie-details">
                    ...
                    <div class="movie-image">
                        <img src="assets/image_movie/filme6.jpg" alt="Punhos de aço">
                    </div>
                    ...
                    <div class="movie-info">
                        ...
                        <!-- Sinopse -->
                        <p class="sinopse">
                            Quando a jovem Thai adota um misterioso gato preto, ela começa a experimentar visões
                            sobrenaturais e eventos perturbadores. Descobre que o gato possui um vínculo com um amuleto
                            antigo que concede poderes e conecta a um mundo de trevas. Em sua busca por respostas, Thai
                            enfrenta perigos e revela segredos que podem mudar sua vida para sempre. "Olhos Felinos" é
                            um thriller psicológico onde o mistério e o terror se entrelaçam.
                        ...
                        <!-- Duração -->
                        <p class="duration">
                            <strong>Duração:</strong> 126 minutos
                        </p>

                        <!-- Data de Lançamento -->
                        <p class="release-date">
                            <strong>Lançamento:</strong> 20 de Setembro de 2024
                        </p>

                        <!-- Gênero -->
                        <p class="genre">
                            <strong>Gênero:</strong> Terror e Suspense
                        </p>
                        ...
                        <?php if (isset($_SESSION['usuario'])): ?>
                            <a href="ingresso_filme/ingresso_olhos.html" class="buy-ticket">Comprar Ingresso</a>
                        <?php else: ?>
                ...
                <div class="movie-cast">
                    ...
                    <div class="cast-container">
                        ...
                        <!-- Ator 2-->
                        <div class="cast-item">
                            <img src="assets/atores/madu.jfif" alt="Ator 1">
                            <p class="actor-name">Maria Eduarda</p>
                        </div>
                        <!-- Ator 3 -->
                        <div class="cast-item">
                            <img src="assets/atores/laruany.jfif">
